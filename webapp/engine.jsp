...
<div class="row row-cols-4 row-cols-md-4">
  <div class="col mb-4">
    <div class="card">
      <img src="image\crankshaft.jpg"  class="card-img-top imgSize" alt="...">
      <div class="card-body">
        <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">crank shaft</li>
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\ep1.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
         <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">shaft</li>
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\piston.png" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">piston</li>
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\piston2.jfif" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
...
<div class="col mb-4">
    <div class="card">
      <img src="image\piston3.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\pistonringcompressor.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">piston compressor</li>
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\cylindercrankshaft.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">cylinder crankshaft</li>
...
<div class="col mb-4">
    <div class="card">
      <img src="image\fanbelt.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">fanbelt</li>
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\bearing shaft.png" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">bearing shaft</li>
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\bearing.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">bearing</li>
...
<div class="col mb-4">
    <div class="card">
      <img src="image\airfilter.png" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">airfilter</li>
...
<div class="col mb-4">
    <div class="card">
      <img src="image\oilfilter.png" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Engine part</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">oilfilter</li>
    <li class="list-group-item">660$</li>
  </ul>
  <div class="card-body">
    <a href="purchaseProduct.jsp" class="card-link">Buy now</a>
