			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar"
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown"><a
						...
						data-bs-toggle="dropdown">All parts</a>
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="engine.jsp">Engines
									Part</a></li>
							<li><a class="dropdown-item" href="tyre.jsp">Tyres</a></li>
							<li><a class="dropdown-item" href="interior.jsp">Interior</a></li>
							<li><a class="dropdown-item" href="headlamp.jsp">Headlamps</a></li>
						</ul></li>
 ...
 <p align="center"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-tools" viewBox="0 0 16 16">
  <path d="M1 0 0 1l2.2 3.081a1 1 0 0 0 .815.419h.07a1 1 0 0 1 .708.293l2.675 2.675-2.617 2.654A3.003 3.003 0 0 0 0 13a3 3 0 1 0 5.878-.851l2.654-2.617.968.968-.305.914a1 1 0 0 0 .242 1.023l3.27 3.27a.997.997 0 0 0 1.414 0l1.586-1.586a.997.997 0 0 0 0-1.414l-3.27-3.27a1 1 0 0 0-1.023-.242L10.5 9.5l-.96-.96 2.68-2.643A3.005 3.005 0 0 0 16 3c0-.269-.035-.53-.102-.777l-2.14 2.141L12 4l-.364-1.757L13.777.102a3 3 0 0 0-3.675 3.68L7.462 6.46 4.793 3.793a1 1 0 0 1-.293-.707v-.071a1 1 0 0 0-.419-.814L1 0Zm9.646 10.646a.5.5 0 0 1 .708 0l2.914 2.915a.5.5 0 0 1-.707.707l-2.915-2.914a.5.5 0 0 1 0-.708ZM3 11l.471.242.529.026.287.445.445.287.026.529L5 13l-.242.471-.026.529-.445.287-.287.445-.529.026L3 15l-.471-.242L2 14.732l-.287-.445L1.268 14l-.026-.529L1 13l.242-.471.026-.529.445-.287.287-.445.529-.026L3 11Z"/>
	...
	<div>
		...
		<h3>Your All Products in cart</h3>
	</div>

	<%
		Map<Product,Integer> pd = (Map<Product,Integer>)request.getAttribute("cart");
		if(pd!=null){
   out.println("<table border='1px' width='100%'><tr><th>Product ID</th><th>Product name</th><th>Product Type</th><th>Product cost</th><th>Quantity</th><th>Action</th></tr>");
	for(Product p: pd.keySet()){
		out.println("<tr><td>"+p.getPid()+"</td><td>"+p.getPname()+"</td><td>"+p.getPtype()+"</td><td>"+p.getPcost()+"</td><td><form action='uqty'><input type='type' name='quantity' value='"+pd.get(p)+"'<input type='submit' value='+'></form></td>");
		out.println("<td><form action='removeFromCart' method='get'><input type='hidden' name='pid' value='"+p.getPid()+"'><input type = 'hidden' name = 'UserId' value='"+u.getUserId()+"'><input type='submit' class='btn btn-danger' value='Remove From Cart'></form></td></tr>");
	}
	
	out.println("</table>");
	out.println("<form action='goPay' method='get'><input type = 'hidden' name = 'UserId' value='"+u.getUserId()+"'><input type='submit'  value='Buy Now'></form>");
		}
%>
