...
<div> <h2> Lights you might be looking for !!!!!!!!!!</h2></div><br>
...
<div class="row row-cols-4 row-cols-md-4">
  <div class="col mb-4">
    <div class="card">
      <img src="image\hl1.jpg"  class="card-img-top imgSize" alt="...">
      <div class="card-body">
        <h5 class="card-title">Headlights</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\hl2.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
         <h5 class="card-title">Headlights</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\hl3.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Headlights</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\hl4.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">Headlights</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
...
<div class="col mb-4">
    <div class="card">
      <img src="image\tl4.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">TailLight</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">TailLight</li>
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\tl3.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">TailLight</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\tl2.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">TailLight</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
...
<div class="col mb-4">
    <div class="card">
      <img src="image\tl1.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">TailLight</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\fl4.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">fogLight</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">fog lamps</li>
  ...
  <div class="col mb-4">
    <div class="card">
      <img src="image\fl3.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">fogLight</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">fog light</li>
...
<div class="col mb-4">
    <div class="card">
      <img src="image\fl2.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">fogLight</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">fog lamp cover</li>
...
<div class="col mb-4">
    <div class="card">
      <img src="image\fl1.jpg" class="card-img-top imgSize" alt="...">
      <div class="card-body">
       <h5 class="card-title">fogLight</h5>
        <p class="card-text"></p>
 <ul class="list-group list-group-flush">
    <li class="list-group-item">fog lamp</li>
    <li class="list-group-item">660$</li>
  </ul>
  <div class="card-body">
    <a href="purchaseProduct.jsp" class="card-link">Buy now</a>
